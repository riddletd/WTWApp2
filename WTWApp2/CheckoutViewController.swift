...
//  WTWApp2
//
//  Created by Alec Rieger on 4/5/17.
...
class CheckoutViewController: UIViewController, STPPaymentContextDelegate {
    ...
    let stripePublishableKey = "pk_test_XvFMMigqg0Q2Brl7IDCqZou9"
    
    // Heroku set up on the backend
    let backendBaseURL: String? = "https://wtwapp2.herokuapp.com"
